...
public class Client {
    ...
    private gui.Client clientGui;

    private final int MAX_LENGTH_SEND = 524288;
    ...
    public Client(String host, int port, gui.Client clientGui) throws IOException {
        this.host = host;
        this.port = port;
